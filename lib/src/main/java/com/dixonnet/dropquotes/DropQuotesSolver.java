...
public class DropQuotesSolver {
    ...
    void solve(Dictionary.DictSize size, String path) throws IOException {
    ...
    public String solve(Dictionary dict, InputStream is) throws IOException {
        ...
        System.out.println("Starting DLX");

        DLX.solve(h, true, rp);

        System.out.println("Finished DLX");
        return rp.getBestResult();
    }
    ...
    private static EntropyScorer scorer = new EntropyScorer();
